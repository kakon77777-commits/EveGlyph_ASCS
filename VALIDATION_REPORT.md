...
An initial replay without `-B` caused Python 3.14 to generate an untracked `validate_v10.cpython-314.pyc` beside the checksum-pinned Python 3.13 bytecode. The repository verifier rejected the extra canonical file. The generated bytecode was moved intact to ignored `tmp/generated-bytecode/`, the pinned Python 3.13 bytecode remained unchanged, and the final replay used `-B` to prevent writes into canonical evidence.
